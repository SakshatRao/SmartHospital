...
def room_occupancy(patient_db):
    ...
    pyo.plot(fig, filename = './assets/room_occupancy.html', auto_open = False, output_type = 'file', include_plotlyjs = True)
...
def monthly_billing(bill_db):
    ...
    fig = go.Figure(data = data, layout = layout)
    pyo.plot(fig, filename = './assets/monthly_billing.html', auto_open = False, output_type = 'file', include_plotlyjs = True)
...
def gender_ratio(staff_db):
    ...
    fig = go.Figure(data = data, layout = layout)
    pyo.plot(fig, filename = './assets/gender_ratio.html', auto_open = False, output_type = 'file', include_plotlyjs = True)
...
def daily_billing(bill_db):
    ...
    fig = go.Figure(data = data, layout = layout)
    pyo.plot(fig, filename = './assets/daily_billing.html', auto_open = False, output_type = 'file', include_plotlyjs = True)
...
def patient_geomap(patient_db):
    ...
    pyo.plot(fig, filename = './assets/patient_geomap.html', auto_open = False, output_type = 'file', include_plotlyjs = True)
